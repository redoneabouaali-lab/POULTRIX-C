    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{ background: "#f8f8fa" }}>
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1.5" style={{ color: "#8a8a96" }}>Start your free month — no credit card needed</p>
        </div>
        ...
        <p className="text-center mt-6 text-xs" style={{ color: "#b0b0b8" }}>
          30 jours gratuits &bull; Annulation à tout moment &bull; POULTRIX &copy; 2026
        </p>
      </div>
    </div>
  );
